...
private func makeServer() async throws -> OAuthServer {
    OAuthServer(storage: try makeStorage(), issuer: "https://mcp.example.com", scopesSupported: ["mcp:tools", "mcp:resources", "mcp:prompts"], served: .core, resourceIdentity: .colocated,
